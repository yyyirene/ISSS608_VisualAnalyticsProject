...
| Element | Description |
|--------|-------------|
| **Main Genre** | Select the root genre to track its influence (default is *Oceanus Folk*) |
| **Year Range** | Filter nodes by release year |
| **Node Type** | Focus on either *Song* or *Album* nodes |
| **Influence Path Depth** | Choose between **1-hop** (direct influence) and **2-hop** (indirect influence paths) |

📸![](images/Genre_Diffusion_Control_Panel.png)

---

### 📈 Timeline Trend

This area plot shows how many songs/albums (grouped by genre) were influenced by the selected genre over time.

- **X-axis:** Release year  
- **Y-axis:** Number of influenced works  
- **Color:** Genre of influenced works

Use this chart to identify **temporal spikes** in influence and **genre-specific waves**.

📸![](images/Genre_Diffusion_Time_Trend.png)

---

### 🌐 Genre Influence Network

A visNetwork graph showing **nodes (songs/albums)** connected by influence edges. This visual helps identify:

- Which works are **directly influenced** by the selected genre
- Which works are **central hubs** of propagation
- **Clusters** of genre influence across time

- Nodes are colored by genre
- Hovering shows detailed metadata (release year, notable, etc.)
- Clicking a node will update the **Detail Panel**

📸![](images/Genre_Diffusion_Influence_Network.png)

---

### 🔁 Genre Influence Backflow (Sankey Diagram)

This Sankey diagram illustrates the **reverse influence** — how other genres eventually influenced the main genre.

- **FromGenre → Oceanus Folk**  
- Each link represents a **count of influence relationships**

This helps capture **genre convergence** and artistic borrowing across time.

📸![](images/Genre_Diffusion _Influence_Backflow.png)

---

### 📑 Detail Panel (Right)

When a node is selected in the Network or Sankey diagram, this panel displays:

- Name
- Representative Works
- Active Year
- Whether it shares collaboration or style with *Sailor Shift*

📸![](images/Genre_Diffusion_Detail_Panel.png)
